...
class FedAvg_Privacy(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(
        ...
        save_metric_to_txt("privacy_leakage", avg_privacy_leakage, server_round, self.PRIVACY_WEIGHT)
        save_metric_to_txt("distortion", avg_distortion, server_round, self.PRIVACY_WEIGHT)
